    ...
    function applyTranslations() {
      ...
      const setPlaceholder = (el, value) => { if(el) el.setAttribute("placeholder", value); };
      const setAriaLabel = (el, value) => { if(el) el.setAttribute("aria-label", value); };
      ...
      setAriaLabel(ui.soundChip, t("audio"));
      ...
      setAriaLabel(ui.btnAvatarNext, t("avatarNext"));
      setText(ui.joinStatus, t("joinHint"));
      setPlaceholder(ui.nameInput, t("nameExample"));
      setPlaceholder(ui.customThemeInput, t("customThemePlaceholder"));
      setPlaceholder(ui.customPromptInput, t("customPromptPlaceholder"));
      ...
      // Profile screen
      setText(ui.profileKicker, state.role === "host" ? t("room") : t("guestKicker"));
      setText(ui.profileTitle, state.role === "host" ? t("hostProfileTitle") : t("guestProfileTitle"));
      setText(ui.profileSideTitle, state.role === "host" ? t("hostProfileSideTitle") : t("guestProfileSideTitle"));
      setText(ui.profileSideText, state.role === "host" ? t("hostProfileSideText") : t("guestProfileSideText"));
      ...
      setText(ui.lobbyTitle, t("preparingRoom"));
      setText(ui.lobbyDesc, t("lobbyDesc"));
      setText(ui.btnToSetup, t("next"));
      setText(ui.durationLead, t("durationLead"));

      // Setup screen
      setText(ui.setupTitle, t("setupTitle"));
      setText(ui.setupDesc, t("setupDesc"));
      ...
      setPlaceholder(ui.customPromptInput, t("extraPrompt"));
    ...
    const ui = {
      ...
      nameInput:$("nameInput"), avatarViewport:$("avatarViewport"), avatarRail:$("avatarRail"), avatarLegend:$("avatarLegend"), avatarEditorKicker:$("avatarEditorKicker"), btnAvatarPrev:$("btnAvatarPrev"), btnAvatarNext:$("btnAvatarNext"), profileStatus:$("profileStatus"), btnBack:$("btnBack"), btnReady:$("btnReady"),
      ...
      generatingLine:$("generatingLine"), generatingKicker:$("generatingKicker"), pausedTitle:$("pausedTitle"), pausedKicker:$("pausedKicker"), pausedCopy:$("pausedCopy"), pausedActions:$("pausedActions"), countdownKicker:$("countdownKicker"), countdownCategory:$("countdownCategory"), countdownCategoryArt:$("countdownCategoryArt"), countdownValue:$("countdownValue"), countdownActions:$("countdownActions"), questionKicker:$("questionKicker"), questionPrompt:$("questionPrompt"), questionCopy:$("questionCopy"), questionTimerRing:$("questionTimerRing"),
      questionTimer:$("questionTimer"), questionAnswers:$("questionAnswers"), answerKicker:$("answerKicker"), answerCorrect:$("answerCorrect"), answerPrompt:$("answerPrompt"),
      scoresKicker:$("scoresKicker"), scoresTitle:$("scoresTitle"), scoresLead:$("scoresLead"), scoresRows:$("scoresRows"), finalActions:$("finalActions"), versusIntroKicker:$("versusIntroKicker"), versusIntroTitle:$("versusIntroTitle"), versusIntroLead:$("versusIntroLead"), versusIntroNames:$("versusIntroNames"), versusIntroCopy:$("versusIntroCopy"), versusIntroCount:$("versusIntroCount"), versusKicker:$("versusKicker"), versusTitle:$("versusTitle"), versusLead:$("versusLead"), versusRoundBadge:$("versusRoundBadge"), versusBurst:$("versusBurst"), versusChampionFx:$("versusChampionFx"), versusChampionText:$("versusChampionText"), versusHandA:$("versusHandA"), versusHandB:$("versusHandB"), versusPlayerA:$("versusPlayerA"), versusPlayerB:$("versusPlayerB"), versusScoreline:$("versusScoreline"), versusTimer:$("versusTimer"), versusRoundCopy:$("versusRoundCopy"), versusButtons:$("versusButtons"), scoreModal:$("scoreModal"), scoreModalKicker:$("scoreModalKicker"), scoreModalTitle:$("scoreModalTitle"), scoreModalRows:$("scoreModalRows"),
    ...
    function renderSetupScene(){
      ...
      if(state.role === "host"){
        ...
        $("btnStartRound").onclick = async () => {
          ...
          if(state.game.selectedMode === "custom" || targetLang === "en"){
            ...
            await broadcastGame();
            renderCurrentScene();
            const theme = targetLang === "en" && state.game.selectedMode === "classic" ? "general knowledge" : (state.game.customConfig.theme || "conocimiento general");
            const tone = targetLang === "en" && state.game.selectedMode === "classic" ? "fun" : (state.game.customConfig.tone || "divertido");
            const difficulty = targetLang === "en" && state.game.selectedMode === "classic" ? "medium" : (state.game.customConfig.difficulty === "media" ? "media-alta" : state.game.customConfig.difficulty);
