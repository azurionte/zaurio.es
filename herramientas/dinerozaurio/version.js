...
(() => {
  ...
  const scripts = [
    './finance/accounting-core.js?v=1508260552',
    './ui/accounts.js?v=1508260552',
    './ui/account-observed-adapter.js?v=1508260552',
    './session-drafts.js?v=1508260552'
  ];
