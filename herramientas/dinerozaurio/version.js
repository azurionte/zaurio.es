...
(() => {
  ...
  const scripts = [
    './finance/accounting-core.js?v=1608260723',
    './ui/accounts.js?v=1608260723',
    './ui/account-observed-adapter.js?v=1608260723',
    './session-drafts.js?v=1608260723',
    './ui/debt-settings-state-bridge.js?v=1608260723',
    './ui/debt-settings-polish.js?v=1608260723',
    './ui/debt-editor-wizard.js?v=1608260723',
    './ui/configuration-modal-polish.js?v=1608260723',
    './period-rollover.js?v=1608260723'
  ];
