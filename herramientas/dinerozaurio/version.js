...
(() => {
  ...
  const scripts = [
    './finance/accounting-core.js?v=1608260758',
    './ui/accounts.js?v=1608260758',
    './ui/account-observed-adapter.js?v=1608260758',
    './session-drafts.js?v=1608260758',
    './ui/debt-settings-state-bridge.js?v=1608260758',
    './ui/debt-settings-polish.js?v=1608260758',
    './ui/debt-editor-wizard.js?v=1608260758',
    './ui/configuration-modal-polish.js?v=1608260758'
  ];
