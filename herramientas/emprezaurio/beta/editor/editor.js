...
export function mountEditor({ onThemePick, onDarkToggle, onMaterialPick, onCustomGradient, onSaveProject, onOpenLibrary, canOpenLibrary }){
      ...
      <div class="brand-suite">
        ...
        <a class="brand" href="/emprezaurio/" aria-label="Ir a Emprezaurio">
          ...
          <span class="brand-copy">
            ...
            <span class="brand-sub">curriculums bonitos en minutos</span>
          </span>
        </a>
      ...
      <div class="menu" id="betaMenu">
        <div class="dropdown" id="ddFile">
          ...
          <div class="dropdown-menu">
            ...
            ${canOpenLibrary ? '<button id="btnLibrary" class="mbtn"><i class="fa-solid fa-layer-group"></i> Mis CVs</button>' : ''}
  ...
  const nav = top.querySelector('#betaNav');
  const menu = top.querySelector('#betaMenu');
